      ...
      <Box sx={{ width: "100%", minHeight: "100vh", bgcolor: "#f8f9fa" }}>
              ...
              <CardContent sx={{ p: 2.5 }}>
                <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
                  ...
                  <Box sx={{ ml: "auto", display: "flex", alignItems: "center" }}>
                    ...
                    <Typography
                      variant="caption"
                      sx={{ color: "#4CAF50", fontWeight: 600, fontSize: "0.75rem" }}
                    >
        ...
        >
          <CardContent sx={{ p: 3 }}>
            <Typography
              variant="h6"
              sx={{ fontWeight: 600, color: "#1A1A1A", mb: 3, fontSize: "1.125rem" }}
            >
              Stock Overview
            </Typography>
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} sm={4}>
                <Box>
                  ...
                  <Typography
                    variant="h4"
                    sx={{ fontWeight: 700, color: "#1A1A1A", mb: 2, fontSize: "2rem" }}
                  >
